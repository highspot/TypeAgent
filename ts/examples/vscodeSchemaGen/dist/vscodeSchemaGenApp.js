...
function parseArg(argName, type, args) {
    ...
    if (!matchedArg) {
        ...
        if (!matchedArg) {
            return type === "number" ? -1 : undefined;
        }
        switch (type) {
            case "number":
...
export async function createVSCodeSchemaGenApp() {
...
//# sourceMappingURL=vscodeSchemaGenApp.js.map
