...
describe("sqlite.objectTable", () => {
    ...
    test("end2end", async () => {
        ...
        const ids = await asyncArray.mapAsync(strings, 1, (s) => table.put(s));
        expect(ids).toHaveLength(strings.length);
        const allNames = await table.allNames();
        expect(ids).toEqual(allNames);
        const strings_get = await asyncArray.mapAsync(ids, 2, (id) => table.get(id));
...
//# sourceMappingURL=sqlite.objectTable.spec.js.map