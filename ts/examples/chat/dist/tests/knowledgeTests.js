...
export function logTiming(clock) {
...
export function testPostings() {
    ...
    const z = knowLib.sets.intersect(knowLib.sets.unique(x.values()), knowLib.sets.unique(y.values()));
    console.log("Intersect");
    for (const value of z) {
        console.log(value);
    }
    console.log("Union");
    const t = knowLib.sets.union(knowLib.sets.unique(x.values()), knowLib.sets.unique(y.values()));
...
//# sourceMappingURL=knowledgeTests.js.map