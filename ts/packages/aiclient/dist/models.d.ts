...
export type CompletionJsonSchema = StructuredOutputJsonSchema | FunctionCallingJsonSchema[];
...
export interface ChatModel extends TypeChatLanguageModel {
     ...
     */
    complete(prompt: string | PromptSection[], usageCallback?: CompleteUsageStatsCallback, jsonSchema?: CompletionJsonSchema): Promise<Result<string>>;
}
export interface ChatModelWithStreaming extends ChatModel {
     ...
     * @param jsonSchema optional json schema. If the json schema is an object, then it uses structured output. If the json schema is an array, then it is function calling.
     */
    completeStream(prompt: string | PromptSection[], usageCallback?: CompleteUsageStatsCallback, jsonSchema?: CompletionJsonSchema): Promise<Result<AsyncIterableIterator<string>>>;
}
/**
