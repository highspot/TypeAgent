...
const testRequest = new RequestAction("do some player blah", fromJsonActions({
...
const schemaNames = getSchemaNamesForActionConfigProvider(await createActionConfigProvider(defaultAgentProviders));
...
ExplainCommand.description = "Explain a request and action";
ExplainCommand.example = [
