...
describe("KnowledgeIndex", () => {
    ...
    testIf("textIndex", () => hasTestKeys(), async () => {
    ...
    async function createIndex(name, semanticIndex) {
        //const context = getContext();
        const rootPath = path.join(getRootDataPath(), name);
        await cleanDir(rootPath);
        return await createTextIndex({ caseSensitive: false, semanticIndex, concurrency: 2 }, rootPath);
    }
    function makeBlocks(strings) {
...
//# sourceMappingURL=knowledgeIndex.spec.js.map