...
import { answerContextToString, splitAnswerContext, } from "../src/conversation/answerContext.js";
...
describe("AnswerGenerator", () => {
    test("splitContext", async () => {
        ...
        let chunkCount = 0;
        for (const chunk of splitAnswerContext(context, maxCharsPerChunk, true)) {
            ++chunkCount;
            if (chunkCount === 1) {
...
//# sourceMappingURL=answerGenerator.spec.js.map