...
export declare function createTextIndex<TSourceId = any>(
...
export declare function searchIndex<TTextId = any, TSourceId = any>(
...
export declare function searchIndexText<TTextId = any, TSourceId = any>(
    index: TextIndex<TTextId, TSourceId>,
    value: string,
    exact: boolean,
    count?: number,
...
export declare function createSemanticIndexFolder(
    folderPath: string,
    folderSettings?: ObjectFolderSettings,
    concurrency?: number,
...
export declare function removeSemanticIndexFolder(
    folderPath: string,
    fSys?: FileSystem,
): Promise<void>;
...
//# sourceMappingURL=knowledgeIndex.d.ts.map
