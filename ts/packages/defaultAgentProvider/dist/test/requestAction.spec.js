...
const testInput = inputs.flatMap((f) => f.entries.map((data) => new RequestAction(data.request, fromJsonActions(data.action))));
...
//# sourceMappingURL=requestAction.spec.js.map