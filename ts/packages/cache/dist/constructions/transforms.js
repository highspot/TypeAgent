...
import { equalNormalizedParamValue, normalizeParamString, normalizeParamValue, } from "../explanation/requestAction.js";
        ...
        if (existingValue !== undefined) {
            ...
            if (!isTransformEntityRecord(value)) {
                if (cacheConflicts) {
                    ...
                    const normExistingValue = normalizeParamValue(existingValue.value);
                    ...
                    if (equalNormalizedParamValue(existingValue.value, value.value)) {
