...
export type GenericExplanationResult<T extends object = object> = GenericExplanationSuccess<T> | GenericExplanationError<T>;
export type ExplanationValidator<T> = (requestAction: RequestAction, explanation: T) => string | undefined;
...
export type ConstructionFactory<T> = (requestAction: RequestAction, explanation: T, constructionCreationConfig: ConstructionCreationConfig) => Construction;
...
export interface GenericExplainer<T extends object = object> {
    ...
    correct?(requestAction: RequestAction, explanation: T, correction: ValidationError): Promise<GenericExplanationResult<T>>;
...
export {};
//# sourceMappingURL=genericExplainer.d.ts.map