...
export interface IConversationThreads {
    ...
    lookupThread(threadDescription: string, maxMatches?: number, thresholdScore?: number): Promise<ScoredThreadIndex[] | undefined>;
...
export interface IndexingEventHandlers {
    onKnowledgeExtracted?: (chunk: TextLocation, knowledgeResult: kpLib.KnowledgeResponse) => boolean;
