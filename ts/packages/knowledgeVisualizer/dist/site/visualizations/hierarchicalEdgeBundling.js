...
export class HierarchicalEdgeBundling {
    ...
    buildNodeHierarchy(data, delimiter = ".") {
        let root;
        const map = new Map();
    ...
    makeChart(data) {
        ...
        const root = tree(this.linkNodes(hierarchy(data).sort((a, b) => ascending(a.height, b.height) ||
...
HierarchicalEdgeBundling.colorin = "#00f";
HierarchicalEdgeBundling.colorout = "#f00";
HierarchicalEdgeBundling.colornone = "#ccc";
//# sourceMappingURL=hierarchicalEdgeBundling.js.map