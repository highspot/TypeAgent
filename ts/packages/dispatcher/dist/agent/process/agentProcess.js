...
const agent = module.instantiate();
...
const checkedProcess = process;
const rpc = createRpc(checkedProcess, agentInvokeHandlers, agentCallHandlers);
...
function createSessionContextShim(contextId, hasSessionStorage, context) {
    return {
