...
export function getUniqueFileName(dirpath, prefix = "", ext = "") {
...
export async function lockInstanceDir(instanceDir) {
    ...
    try {
        ...
        throw new Error(`Unable to lock instance directory ${instanceDir}. Only one client per instance directory can be active at a time.`);
    }
}
export function ensureCacheDir(instanceDir) {
