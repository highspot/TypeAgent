...
import { getNormalizedDateRange, getNormalizedDateTimes, getTimeZoneName, getUniqueLocalId, } from "common-utils";
        ...
        case "addParticipants":
            ...
            if (actionEvent != undefined &&
                ...
                if (eventId && typeof eventId === "string") {
                    ...
                    debug(chalk.bgCyanBright(`Successfully added participant(s) for (local eventid:${localId}) event:${eventId}`));
...
//# sourceMappingURL=calendarActionHandlerV1.js.map