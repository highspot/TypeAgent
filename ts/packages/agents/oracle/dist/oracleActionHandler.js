...
class RequestCommandHandler {
    constructor() {
        this.description = "Send a request to the Oracle";
        this.parameters = {
...
async function executeOracleAction(action, context) {
    let result = await handleOracleAction(action, context.sessionContext.agentContext);
    return result;
}
...
async function handleOracleAction(action, oracleContext) {
...
function makeRandomResponse(input) {
...
//# sourceMappingURL=oracleActionHandler.js.map