...
export async function createTokenProvider(storage) {
    ...
    const refreshTokenStorage = storage
        ...
        : undefined;
    return new TokenProvider(baseClientId, baseClientSecret, port, scopes, refreshTokenStorage);
}
//# sourceMappingURL=defaultTokenProvider.js.map