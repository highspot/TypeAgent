...
export class AzureStorageProvider {
    constructor() {
        ...
        this.containerName = getEnvSetting(env, openai.EnvVars.AZURE_STORAGE_CONTAINER, undefined, "");
        // blob storage config
        this.accountURL = `https://${this.storageAccount}.blob.core.windows.net`;
        this.blobServiceClient = new BlobServiceClient(this.accountURL, new DefaultAzureCredential());
    }
...
//# sourceMappingURL=azureStorageProvider.js.map